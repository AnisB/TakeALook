...
% la couleur Couleur = [R G B] dans le triangle 2D de sommmets S1, S2, S3 donnés par
% Sommets = [S1.lig S1.col ; S2.lig S2.col ; S3.lig S3.col]
% si la distance donnée par la valeur Barry est celle contenue dans le ZBuffer ZB
